...
# Ramdisk
PRODUCT_COPY_FILES += \
	${bm_device}/profiles/ramdisk/ueventd.mapphone_cdma.rc:root/ueventd.mapphone_cdma.rc \
	${bm_device}/profiles/ramdisk/init.usb.rc:root/init.usb.rc \
	${bm_device}/profiles/ramdisk/init.mapphone_cdma.rc:root/init.mapphone_cdma.rc \
	${bm_device}/profiles/ramdisk/fstab.mapphone_cdma:root/fstab.mapphone_cdma \
