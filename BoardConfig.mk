...
TARGET_RECOVERY_INITRC := device/moto/shadow-common/ramdisk/init-recovery.rc
...
hboot:
	...
	make -C  $(ANDROID_BUILD_TOP)/device/moto/shadow-common/bootstrap/hboot ARCH=arm CROSS_COMPILE="arm-eabi-"
