...
COMPAT_MODULES:
	...
	make -C device/moto/shadow-common/modules/backports KERNEL_DIR=$(KERNEL_OUT) KLIB=$(KERNEL_OUT) KLIB_BUILD=$(KERNEL_OUT) ARCH=arm CROSS_COMPILE="arm-eabi-" defconfig-mapphone
	make -C device/moto/shadow-common/modules/backports KERNEL_DIR=$(KERNEL_OUT) KLIB=$(KERNEL_OUT) KLIB_BUILD=$(KERNEL_OUT) ARCH=arm CROSS_COMPILE="arm-eabi-"
...
hboot:
	...
	make -C  $(ANDROID_BUILD_TOP)/device/moto/shadow-common/hboot ARCH=arm CROSS_COMPILE="arm-eabi-"
	mv $(ANDROID_BUILD_TOP)/device/moto/shadow-common/hboot/hboot.bin $(PRODUCT_OUT)/system/bootmenu/2nd-boot/
	make clean -C $(ANDROID_BUILD_TOP)/device/moto/shadow-common/hboot
...
#TARGET_PREBUILT_KERNEL := $(ANDROID_BUILD_TOP)/device/moto/shadow-common/kernel
